...
*BMI* is a derived variable and thus, passive imputation was used to preserve the relationship between *height* and *weight*. 
...
For the amount of imputations we followed the guideline to set this amount equal to the percentage of missing values (16.8%), rounded up to 17. 

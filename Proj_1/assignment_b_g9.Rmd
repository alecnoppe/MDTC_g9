...
# Scientifically Interesting Model - *Alec stuff here, current stuff can be thrown*
...
rownames(a) <- c("(Intercept)", "age", "rest", "bmi", "sex (female)", "smoke (yes)", "intenstiy (moderate)", "intenstiy (low)")
a[,2:6]
```
